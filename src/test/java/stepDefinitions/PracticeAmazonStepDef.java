...
public class PracticeAmazonStepDef {
   ...
   // Faker faker=new Faker();  Faker.instance() ile  faker objesi olusturmaya gerek kalmaz
    ...
    public void faker_kullanarak_e_posta_gonderir() {
       ...
       practiceAmazonPage.emailBox.sendKeys(Faker.instance().internet().emailAddress()); // faker objesi olusturmaya gerek kalmaz
    }
    ...
    public void there_was_a_problem_mesajini_dogrular() {
        ...
        Assert.assertEquals("Problem mesaji = Esit degil",expectedText,actualText);  // hata mesaji verebiliriz
    }
